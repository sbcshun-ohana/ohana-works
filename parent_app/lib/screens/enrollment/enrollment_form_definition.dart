...
const enrollmentSteps = <StepDef>[
  ...
  StepDef(
    ...
    fields: [
      ...
      // 読みやすさのため「場所→利用ルール→安全→路上駐車禁止とその帰結」の順の箇条書き(俊指示 2026-08-17)
      FieldDef('car_parking_notice',
          '【駐車場のご利用について】\n'
          '・保育園の専用駐車場はありません。テナントビルの共同駐車場をご利用ください\n'
          '・駐車場は他のご家庭も利用します。送迎時のみ利用し、速やかにご退出ください\n'
          '・お買い物など、保育園の利用に関係のない目的での駐車は禁止です\n'
          '・入出庫の際は、車の周りを小さなお子様が歩いている場合があります。十分にご注意ください\n'
          '・駐車場に空きがない場合でも、路上駐車は絶対にしないでください\n'
          '・駐車場の空き待ち等でお迎えが遅れ、延長保育となった場合は延長保育料金がかかります\n'
          '・路上駐車が確認され、保育園への通報等があった場合、以後の自動車での通園を禁止する場合があります',
          type: FieldType.notice, required: true,
          visibleWhenKey: 'method', visibleWhenEquals: '自動車'),
